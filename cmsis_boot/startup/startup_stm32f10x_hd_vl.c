/**
 ******************************************************************************
 * @file      startup_stm32f10x_hd_vl.c
 * @author    Coocox
 * @version   V1.0
 * @date      3/7/2011
 * @brief     STM32F10x High Density Value line Devices Startup code.
...
void WEAK  TIM12_IRQHandler(void);
void WEAK  TIM13_IRQHandler(void);
...
{       
  ...
  TIM12_IRQHandler,             /*!< 43: TIM12                                */
  TIM13_IRQHandler,             /*!< 44: TIM13                                */ 
  TIM14_IRQHandler,             /*!< 45: TIM14                                */ 
  0,                            /*!< 46: Reserved                             */ 
  0,                            /*!< 47: Reserved                             */ 
